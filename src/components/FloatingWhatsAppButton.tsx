...
export default function FloatingWhatsAppButton() {
  const confirmHelp = () => {
    let encodedURL = encodeURIComponent(`
      Hallo, Saya Ingin Konsultasi Kendala Website Member`);
    let link = `${process.env.NEXT_PUBLIC_ADMIN_WA_WEBSITE}?text=${encodedURL}`
  ...
  return (
    <div className="fixed bottom-4 right-4 z-99999">
      {/* <a
        href="https://api.whatsapp.com/send/?phone=6285183145746&text=Hallo%2C+Saya+Ingin+Konsultasi+Kendala+Website+Member&type=phone_number&app_absent=0" // Replace with your WhatsApp link
        target="_blank"
