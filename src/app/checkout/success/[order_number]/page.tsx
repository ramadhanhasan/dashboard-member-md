...
const CheckoutPage = ({ params }: { params: { order_number: string } }) => {
  ...
  return (
    <>
      ...
      {isAuth && isLoaded && (
        <DefaultLayout>
          {/* <div className="mx-auto lg:max-w-screen-lg py-4 md:py-6 2xl:py-10"> */}
                ...
                {/* <div className="bg-gray-100 items-center justify-center p-4"> */}
                  <Card className="w-full">
                    <CardHeader className="text-center mt-5">
                      ...
                      <CardDescription>
                        Selanjutnya, silahkan transfer sesuai nominal (ada 3
                        kode unik) ke rekening yang tertera di bawah ini :
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      ...
                      <div className="space-y-2 text-center">
                        ...
                        <p>
                          ...
                          {formatPrice(data?.total_net_price || 0)} ke nomer
                      ...
                      <p>
                        ...
                        bisa langsung konfirmasi melalui Whatsapp Admin, untuk
                        bisa dilakukan verifikasi pembayaran agar bisa masuk ke
                        Website Mahir Digital.
                      </p>
                      ...
                      {/* </Link> */}
                      <p>
                        Kalau butuh bantuan atau ada kendala pembayaran silahkan
                        klik disini ya :
                      </p>
                      <Button
                        onClick={confirmHelp}
                      ...
                      <p>
                        Terimakasih sudah menjadi bagian dari Mahir Digital!
                        Semangat belajar & prakteknya, semoga diberi kemudahan
                        dalam menerima ilmu baru ❤️
                      </p>
                      <br />
                      <p className="m-0">Salam Hangat,</p>
                      <p className="m-0 text-xl font-bold">Mahir Digital ID</p>
                      <p className="m-0 font-bold">
                        #Ngajarin #Nemenin #Nolongin
                      </p>
                    </CardContent>
                  </Card>
                {/* </div> */}
