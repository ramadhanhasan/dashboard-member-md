...
const CoursePage = () => {
  ...
  const {
    dataMembershipProduct,
    currentPageMembershipProduct,
    totalItemMembershipProduct,
    totalPageMembershipProduct,
    isLoadingMembershipProduct,
      ...
      {isLoadingMembershipProduct ? (
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-5 p-4 text-center shadow-default dark:border-strokedark dark:bg-boxdark md:p-6 xl:p-9">
            ...
            <p className="dark:text-gray-400 mb-6 text-lg font-bold text-yellow-500 sm:px-16 lg:text-xl xl:px-48">
