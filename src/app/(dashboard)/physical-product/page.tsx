  ...
  return (
    <DefaultLayout>
      <div className="mx-auto max-w-7xl">
        ...
        PRODUK FISIK dengan profit tinggi yang siap kamu pasarkan 😊</p>
        <div className="bg-black m-auto mb-5 text-white p-8 rounded-lg shadow-lg  max-w-lg">
        <h2 className="text-xl font-bold mb-4">Fasilitas dan benefit :</h2>
        <ul className="space-y-2">
          <li className="flex text-justify">
            <Check width={24} height={24} />
            <span className="ml-2">Bisa dropship (tanpa repot stok dan kirim produk)</span>
          </li>
          <li className="flex text-justify">
            <Check width={24} height={24} />
