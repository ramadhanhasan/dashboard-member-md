...
import { Calendar, Circle, CircleCheck, LinkIcon, LockOpen, MapPin } from "lucide-react";
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col flex-col-reverse lg:flex-row lg:space-x-8">
          ...
          <div className="top-8 flex-shrink-0 lg:w-1/3">
            ...
            <p className="font-bold capitalize">{data?.implementation}</p>
            <p className="mr-2 text-xs">
              <Calendar width={20} className="grey mr-2 inline" />
              {TimestampConverter(data?.start_date, "DD-MM-YY HH:mm")} -{" "}
		...
		C276.546,215.678,222.799,268.994,156.734,268.994z"
                    ...
                    <>
                      <Link
                        href={process.env.NEXT_PUBLIC_ADMIN_WA_EVENT ?? ""}
                        target="_blank"
